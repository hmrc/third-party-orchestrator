...
object AppDependencies {
  ...
  private val appDomainVersion = "0.74.0"
  private val appEventVersion  = "0.78.0" // Ensure this version of the application-events library uses the appDomainVersion above
